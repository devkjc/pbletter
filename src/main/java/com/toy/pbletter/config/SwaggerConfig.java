package com.toy.pbletter.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket swaggerApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(swaggerInfo())
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.toy.pbletter"))
    ...
    private ApiInfo swaggerInfo() {
        return new ApiInfoBuilder().title("PostBird LETTER API")
                .description("포스트버드 편지 api 문서 입니다. ").build();
    }
